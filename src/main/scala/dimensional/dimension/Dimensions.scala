...
object Dimensions:
  ...
  extension[
    ...
    def asStringWith[
      L2 <: IntT, T2 <: IntT
    ](unit: Dim[L2, T2], unitString: String)(using
      l: L, t: T,
      l2: L2, t2: T2
    ): String =
     ...
     */
    inline def in(unit: Dim[L, T]): Double = x / unit
    ...
    inline def root[E <: NonZeroIntT](n: E)(using
      Divides[E, L], Divides[E, T]
    ): Root[Dim[L, T], E] = typelevelint.root(x, n)
end Dimensions
